/* =====================================================================
   ...
   NA MESMA PASTA do HTML (a raiz do repositório), testando nesta ordem:
       <chave>.jpg
       <chave>.jpeg
       <chave>.png
       <chave>.webp
   Ou seja: salve a imagem do lado do arquivo HTML e do fotos.js, com o
   NOME EXATO da chave da carta (veja a lista abaixo) e uma dessas
   extensões. Exemplo: para o Zeus, salve o arquivo como "zeus.jpg" (ou
   .jpeg/.png/.webp) na raiz do repositório. Não precisa mexer em nada
   ...
   Troque as aspas vazias "" pelo endereço da foto. Pode ser:
     ...
     2) Um caminho de arquivo local: zeus: "zeus.png",
